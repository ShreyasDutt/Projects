...
function Landingpage() {
    ...
    const sucess = () => toast.success('QR Generated Successfully!', {
        position: "top-right",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
            ...
            <div className={"flex items-center justify-center"}>
                ...
                <div className={" border p-4 rounded-xl shadow-xl flex flex-col bg-white w-80 mt-10 "}>
                    ...
                    <div className={"flex items-center mt-3"}>
                        <Button onClick={handleGenerateQR} className={"w-full h-10"}
                    ...
                    {qrLink && (
                        ...
                        <div className={"mt-3 border-2 px-6 py-6 h-auto w-auto"}>
                            ...
                            <Button
                                ...
                                className={"w-full h-10 mt-4"} variant="outlined"
                            >
                                <a
                                    ref={downloadLinkRef}
                                    className="block text-black visited:text-black"
                                >
                                    Download QR
                                </a>
                            </Button>
